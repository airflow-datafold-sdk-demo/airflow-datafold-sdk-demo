...
VALUES
(1, 'Charlie', 'Eastern Gray Squirrel', 300, 10.5, 'Pistachio', 2.5, 'Tree Climbing'),
(2, 'Samantha', 'Fox Squirrel', 400, 12.2, 'Macadamia', 3.0, 'Burrowing'),
(3, 'Rusty', 'Red Squirrel', 251, 9.8, 'Pine Nut', 2.2, 'Nut Hoarding'),
(4, 'Sandy', 'Ground Squirrel', 350, 11.0, 'Pistachio', 2.8, 'Digging Tunnels'),
(5, 'Glider', 'Flying Squirrel', 150, 8.5, 'Walnut', 4.2, 'Glider'),
(6, 'Snowy', 'Arctic Ground Squirrel', 450, 14.7, 'Macadamia', 3.5, 'Hibernating'),
(7, 'Basker', 'Marmot', 600, 18.0, 'Pistachio', 6.0, 'Basking'),
(8, 'Cheeks', 'Chipmunk', 200, 7.5, 'Macadamia', 1.8, 'Cheek Pouches'),
